MODULE OPERATORS_3D
    ...
    SUBROUTINE POINT_FACE_CONNECTING_TYPE(TYP)
        ...
        CALL POINT_FACE_CONNECTING(SURFACE_CURRENT%SURFACE_POINTS_NUM, SURFACE_CURRENT%SURFACE_POINTS, SURFACE_CURRENT%SURFACE_FACES_NUM, SURFACE_CURRENT%SURFACE_FACES, SURFACE_CURRENT%POINT_FACE_CONNECTION_NUM, SURFACE_CURRENT%POINT_FACE_CONNECTION)
        
    END SUBROUTINE POINT_FACE_CONNECTING_TYPE
    
    SUBROUTINE POINT_FACE_CONNECTING(POINT_NUM, POINT, FACE_NUM, FACE, CONNECTION_NUM, CONNECTION)
        IMPLICIT NONE
        INTEGER :: POINT_NUM
        REAL(8) :: POINT(:,:)
        INTEGER :: FACE_NUM
...
END IF
    ...
    SUBROUTINE FIND_CASE_INTERFACE()
        IMPLICIT NONE
        LOGICAL :: FLAG
        REAL(8) :: PHI1, PHI2, PHI3, PHI4, PHI5, PHI6, MINPHI
        INTEGER :: I, J, K, I1, J1, N1
...
if(case1==1) THEN
    ...
    SUBROUTINE FIND_RELATEDFACE(TYP1, TYP2, case1, ISPROJ)
	IMPLICIT NONE
        INTEGER :: TYP1, TYP2
...
!    END SUBROUTINE UPDATE_RELATEDFACE
    ...
    SUBROUTINE LOADING_COEFFS_SURFACE_STRUCT(NEW_PROPEL_POINT_NUM, NEW_PROPEL_POINT, NEW_PROPEL_FACE_NUM, NEW_PROPEL_FACE, NEW_PROPEL_LOC, NEW_PROPEL_ONINTERFACE, NEW_PROPEL_CONNECTION_NUM, NEW_PROPEL_CONNECTION)
        IMPLICIT NONE
        INTEGER :: NEW_PROPEL_POINT_NUM
        REAL(8) :: NEW_PROPEL_POINT(3,NEW_PROPEL_POINT_NUM)
        INTEGER :: NEW_PROPEL_FACE_NUM
        INTEGER :: NEW_PROPEL_FACE(3,NEW_PROPEL_FACE_NUM)
        INTEGER :: NEW_PROPEL_LOC(NEW_PROPEL_FACE_NUM)
        
        INTEGER :: NEW_PROPEL_CONNECTION_NUM(:)
        INTEGER :: NEW_PROPEL_CONNECTION(:,:)
        INTEGER :: NEW_PROPEL_ONINTERFACE(:)
        
        NEW_PROPEL_LOC(:) = 0
        NEW_PROPEL_CONNECTION_NUM(:) = 0
        NEW_PROPEL_CONNECTION(:,:) = 0
        NEW_PROPEL_ONINTERFACE(:) = 0
        
        CALL POINT_FACE_CONNECTING(NEW_PROPEL_POINT_NUM, NEW_PROPEL_POINT, NEW_PROPEL_FACE_NUM, NEW_PROPEL_FACE, NEW_PROPEL_CONNECTION_NUM, NEW_PROPEL_CONNECTION)
