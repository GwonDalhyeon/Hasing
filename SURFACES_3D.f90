MODULE SURFACES_3D
    ...
    SUBROUTINE UNSIGNED_DISTANCE_FACE_POINT(V,W1,W2,W3,DIST)
        ...
        INTEGER :: IMIN
        REAL(8) :: DIST, POINTDIST
        REAL(8) :: A1(3),A2(3),A3(3), W1(3),W2(3),W3(3)
        REAL(8) :: N(3), C1(3), C2(3)
        ...
        ELSE IF(INNER1<=0) THEN
            CALL DISTANCE_LINE_POINT(V,A1,A2,DIST)
        ELSE
            CALL DISTANCE_LINE_POINT(V,A1,A3,DIST)
        END IF
    ...
    SUBROUTINE INTERPOLATION_ONE_FACE(V, V1, V2, V3, DATA1, DATA2, DATA3,       INTER_DATA)
        ...
        REAL(8) :: A1(3),A2(3),A3(3), TEMPDIST, POINTDIST
        REAL(8) :: B1, B2, B3
        REAL(8) :: N(3), C1(3), C2(3)
        REAL(8) :: ROT1, ROT2, INNER1, INNER2
    ...
    SUBROUTINE MESH_QUALITY_SQUARE(POINT_NUM, POINT, FACE_NUM, FACE, INITIAL_AREA, QUALITY_ARRAY, FILE_NUM, TYP)
        IMPLICIT NONE
        INTEGER :: POINT_NUM
        REAL(8) :: POINT(:,:)
        INTEGER :: FACE_NUM
    ...
    SUBROUTINE MESH_QUALITY_TRIANGLE(POINT_NUM, POINT, FACE_NUM, FACE, INITIAL_AREA, QUALITY_ARRAY, FILE_NUM, TYP)
        IMPLICIT NONE
        INTEGER :: POINT_NUM
        REAL(8) :: POINT(:,:)
        INTEGER :: FACE_NUM
