...
!    END SUBROUTINE FIND_INTERFACE_CLUSTER
    ...
    SUBROUTINE RELATE_INTERFACE_POINT_ITER(V, POINT_NUM, POINT, FACE_NUM, FACE, CURRENT_HASH, R, IDX, V_RET)
        IMPLICIT NONE
        INTEGER :: POINT_NUM
        REAL(8) :: POINT(:,:)
        INTEGER :: FACE_NUM
        ...
        INTEGER :: N2, IDX, I
        REAL(8) :: R, V(3), V1(3), V2(3), V3(3), V_RET(3), TEMPDIST
    ...
    SUBROUTINE RELATE_INTERFACE_POINT(V, POINT_NUM, POINT, FACE_NUM, FACE, N1,CURRENT_HASH,  DIR, IDX, V_RET)
        IMPLICIT NONE
        INTEGER :: POINT_NUM
        REAL(8) :: POINT(:,:)
        INTEGER :: FACE_NUM
        ...
        INTEGER :: N1, DIR, IDX
        REAL(8) :: V(3), V_RET(3), R
        
        R =  MAX(DOMAIN_MAX(1) - DOMAIN_MIN(1), DOMAIN_MAX(2) - DOMAIN_MIN(2), DOMAIN_MAX(3) - DOMAIN_MIN(3))
        
        NBHD_HASH => CURRENT_HASH
        CALL RELATE_INTERFACE_POINT_ITER(V, POINT_NUM, POINT, FACE_NUM, FACE, NBHD_HASH, R, IDX, V_RET)
        ...
        NULLIFY(NBHD_HASH)
    END SUBROUTINE RELATE_INTERFACE_POINT
    
    SUBROUTINE FIND_RELATED_FACE_INTERFACE(TYP1_POINT_NUM, TYP1_POINT, TYP1_FACE_NUM, TYP1_FACE, TYP2_POINT_NUM, TYP2_POINT, TYP2_FACE_NUM, TYP2_FACE, RELATED_FACE, PROJECTION_POINT)
        IMPLICIT NONE
        ...
        NULLIFY(HASH0)
        CALL GENERATE_HASH_V2(TYP1_POINT_NUM,TYP1_POINT,TYP1_FACE_NUM,TYP1_FACE,1,TYP2_POINT_NUM,TYP2_POINT,TYP2_FACE_NUM,TYP2_FACE,2, 1, 1, 1, HASH_NUM1, HASH_NUM2, HASH_NUM3, HASH_SIZE, HASH0)
        ...
        DO WHILE (ASSOCIATED(TEMP_HASH0))
            DO N1 = 1, TEMP_HASH0%ELEMENT_NUM1
                ...
                CALL RELATE_INTERFACE_POINT(TYP1_POINT(:,I), TYP2_POINT_NUM, TYP2_POINT, TYP2_FACE_NUM, TYP2_FACE, N1,TEMP_HASH0,  DIR, IDX,V)
    ...
    SUBROUTINE DATA_TRANSFER_WITHOUT_CR(TYP1_POINT_NUM, TYP1_POINT, TYP1_FACE_NUM, TYP1_FACE, CR_SOURCE, TYP2_POINT_NUM, TYP2_POINT, TYP2_FACE_NUM, TYP2_FACE, CR_TARGET)
	IMPLICIT NONE
        ...
        CALL FIND_RELATED_FACE_INTERFACE(TYP2_POINT_NUM, TYP2_POINT, TYP2_FACE_NUM, TYP2_FACE, TYP1_POINT_NUM, TYP1_POINT, TYP1_FACE_NUM, TYP1_FACE, RELATED_FACE, PROJECTION_POINT)
